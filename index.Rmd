...
When we look at sequence data there are a number of file types that you will regularly come into contact with. The most common of these however are .fasta and .fastq files. Here we will have a look at some key features and differences of these file types. 
...
Use the `head` command to have a look at the first few lines of each of the four files stored in `refseq`. An example of the `head` commands useage is as follows;

```
head mouse.1.protein.faa 
```
What differences do you notice about the four files? 
